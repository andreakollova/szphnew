...
export const metadata: Metadata = {
  title: "Video",
  description: "Videá zo slovenského pozemného hokeja — highlighty, zápasy, tréningy.",
};

export default async function VideoPage() {
  const cookieStore = await cookies();
  const supabase = createServerSupabaseClient(cookieStore);
  const videos = await getPublishedVideos(supabase, {
    site: "fieldhockey",
    limit: 24,
  }).catch(() => []);
  ...
  return (
    <div className="container-szph pt-28 pb-20">
      <div className="mb-12">
        ...
        <h1 className="text-display text-white mt-2">Video zóna</h1>
      </div>
